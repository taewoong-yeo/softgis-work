			...
			<div class="admin-panel admin-grid">
				<div class="admin-panel-inner">
					<table class="admin-grid-el">
						<thead>
							<tr>
								<th data-field="faq_id" data-fit>번호</th>
								<th data-field="faq_cat_nm" data-fit>FAQ유형</th>
								<th data-field="faq_title">제목</th>
				...
				<div class="admin-panel-inner">
					<form method="POST" class="form admin-form-el">
						<div class="form-field">
							<label for="faq_cat" class="form-required">FAQ유형</label>
							<select name="faq_cat" id="faq_cat">
								<option disabled selected>FAQ유형 선택</option>
								<t:code-as-option group="FAQ_CAT" />
							</select>
						</div>
						<div class="form-field">
							<label for="faq_title" class="form-required">제목</label>
							<input name="faq_title" id="faq_title" placeholder="제목" >	
						</div>
						<div class="form-field">
							<label for="faq_content" class="form-required">내용</label>
							<textarea id="faq_content" name="faq_content" rows="10" style="width:100%; height:250px"></textarea>
						</div>
