...
<t:subapp>
	<div class="title_bg">
		<div class="title_container">
			<div class="title_wrap">
				...
				<span>함께할지도 등록화면입니다.</span>
			</div>
			<div class="title_btn">
				<a href="<c:url value='/cmmntyMap/cmmnty-list.do'/>" class="icon_wrap">
					...
					<div class="sample_slide">
						...
						<div class="defaultImage slick-list">
							<div class="default_slide">
								...
								<!-- <div class="variableSlider slick-slide image15"></div>
								<div class="variableSlider slick-slide image16"></div>
								<div class="variableSlider slick-slide image17"></div>
								<div class="variableSlider slick-slide image18"></div>
								<div class="variableSlider slick-slide image19"></div>
								<div class="variableSlider slick-slide image20"></div>
								<div class="variableSlider slick-slide image21"></div> -->
							</div>
						</div>
						</section>
					</div>
	...
	<div class="sub-main cmmntyMap">
		<form id="submitForm" method="post" enctype="multipart/form-data" action="<c:url value='/cmmntyMap/insertCmmntyMap.do'/>">
		<input type="hidden" name="temp_yn" value="N"/>
		<input type="hidden" name="map_sel_option"/>
		...
		<div class="sub-wrap">
			<div class="sub-content">
				...
				<div class="info-form default">
					<div class="formItemName">
						<p class="category" class="form-required">제목</p>
						<input type="text" name="mapng_title" id="mapng_title" maxlength="50">
					</div>
					<div class="formItemName">
						<p class="category" class="form-required">소개</p>
						<textarea name="mapng_desc" id="mapng_desc" rows="5" maxlength="200"></textarea>
					</div>
					<div class="formItemName">
					...
					<div class="formItemName wrapRow">
						<p class="category" class="form-required">등록구분</p>
						<input type="hidden" name="map_sel_option"/>
						<select id="map_sel_cd" name="map_sel_cd">
							<option value="">선택</option>
							<t:code-as-option group="MAP_SEL" />
						</select>
						<button type="button" class="settingButton">설정하기</button>
					</div>
					<div class="formItemName marker_wrap">
			...
			<div class="sub-content">
				...
				<div class="info-form default">
					<div class="formItemName">
						...
						<select id="area_cd" name="area_cd">
							...
							<c:forEach items="${bnd_sd_list }" var="item">
								<option value="${item.sd_cd }">${item.sd_nm }</option>
							</c:forEach>
						</select>
					...
					<div class="formItemName">
						...
						<div class="formInputBox">
							...
							<div class="formCheckBox">
								<input type="checkbox" name="" id="dontCareCheck" checked>
					...
					<div class="formItemName">
						<p class="category" class="form-required">의견참여방법</p>
					...
					<div class="formItemName">
						<p class="category" class="form-required">썸네일등록</p>
