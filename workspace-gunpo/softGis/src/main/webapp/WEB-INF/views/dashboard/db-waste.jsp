	...
	<hr class="horizontal dark mt-0">
		<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a class="nav-link active" href="db-waste.do">
						<svg width="28" height="29" viewBox="0 0 28 29" xmlns="http://www.w3.org/2000/svg">
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
	...
	<div class="mob-dashboard-nav">
		<ul>
			...
			<li>
				<a class="active" href="db-waste.do">
					<svg width="46" height="46" viewBox="0 0 46 46" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
					    <defs>
						...
						<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" >
							<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
								<div class="items" data-sort="4">
									<div class="card-box" data-div-name="yearWasteCount" data-chart="yearWasteCount" >
										<div class="card-title">
											<h3><span class="cht-title"></span> <span class="cht-std"></span></h3>
										</div>
										<div class="card-content">
											<div id="yearWasteCount" style="height: 250px;"></div>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-lg-6">
					<div class="card">
						<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" >
							<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
								<div class="items" data-sort="4">
									<div class="card-box" data-div-name="areaWasteCount" data-chart="areaWasteCount" >
										<div class="card-title">
											<h3><span class="cht-title"></span> <span class="cht-std"></span></h3>
										</div>
									<div class="card-content">
										<div id="areaWasteCount" style="height: 250px;"></div>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row col-lg-12" style="padding-right: 0;">
				<div class="card p-3">
					<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
						<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
							<div class="items" data-sort="4">
								<div class="card-box" data-div-name="yearWasteIncrease" data-chart="yearWasteIncrease" >
									<div class="card-title">
										<h3><span class="cht-title"></span> <span class="cht-std"></span></h3>
									</div>
									<div class="card-content">
										<div id="yearWasteIncrease" style="height: 250px"></div>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="row mt-4 areaPopltnCount" style="display: none;">
		<div class="mb-4">
			<div class="card p-3">
				<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
					<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
						<div class="items" data-sort="4">
							<div class="card-box" data-div-name="areaPopltnCount" data-chart="areaPopltnCount" >
								<div class="card-title">
									<h3><span class="cht-title"></span> <span class="cht-std"></span></h3>
								</div>
								<div class="card-content">
									<div id="areaPopltnCount" style="height:210px"></div>
								</div>
							</div>
						</div>
					</div>
