...
<!-- 	</div> -->
	<hr class="horizontal dark mt-0">
		<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link  active" href="db-ur.do">
				...
				<li class="nav-item">
					<a class="nav-link"  href="db-corona.do">
						<svg width="28" height="29" viewBox="0 0 28 29" xmlns="http://www.w3.org/2000/svg">
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4" style="padding-left: 0;">
			...
			<div class="dashboard-opt">
				...
				<div class="adm-cd">
					...
					<c:forEach var="i" begin="2015" end="${year }" step="1">
						<option value="${i }" <c:if test="${i eq 2022 }">selected</c:if>>${i }년</option>
					</c:forEach>
					</select>
				</div>
				<div class="adm-cd">
			...
			<div class="row col-lg-4">
				<div class="card p-3">
					<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
						<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3" style="padding: 0 !important;">
						...
						<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" >
							<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
								<div class="items" data-sort="4">
									<div class="card-box" data-div-name="yearEmptyHouse" data-chart="yearEmptyHouse" >
										<div class="card-title">
											<h3><span class="cht-title"></span> </h3>
										</div>
										<div class="card-content">
											<div id="yearEmptyHouse" style="height:150px"></div>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-lg-6">
					<div class="card p-3">
						<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
							<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
								<div class="items" data-sort="4">
									<div class="card-box" data-div-name="stleEmptyHouse" data-chart="stleEmptyHouse" >
										<div class="card-title">
											<h3><span class="cht-title"></span> </h3>
										</div>
										<div class="card-content">
											<div id="stleEmptyHouse" style="height:150px"></div>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-lg-6 mt-4">
					<div class="card p-3">
						<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" >
							<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
								<div class="items" data-sort="4">
									<div class="card-box" data-div-name="yearStleEmptyHouse" data-chart="yearStleEmptyHouse" >
										<div class="card-title">
											<h3><span class="cht-title"></span> </h3>
										</div>
										<div class="card-content">
											<div id="yearStleEmptyHouse" style="height:300px"></div>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-lg-6 mt-4">
					<div class="card p-3">
						<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
							<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
								<div class="items" data-sort="4">
					                <div class="card-box" data-div-name="stleEmptyHouseIncrease" data-chart="stleEmptyHouseIncrease" >
										<div class="card-title">
											<h3><span class="cht-title"></span> </h3>
										</div>
										<div class="card-content">
											<div id="stleEmptyHouseIncrease" style="height:300px"></div>
										</div>
									</div>
								</div>
							</div>
        	...
        	<div class="col-lg-6 mb-4">
        		<div class="card p-3">
        			<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
        				<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
							<div class="items" data-sort="4">
				                <div class="card-box" data-div-name="areaEmptyHouse" data-chart="areaEmptyHouse" >
									<div class="card-title">
										<h3><span class="cht-title"></span> </h3>
									</div>
									<div class="card-content">
										<div id="areaEmptyHouse" style="height:210px"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
							<div class="items" data-sort="4">
								<div class="card-box" data-div-name="resultData" data-chart="resultData" >
									...
									<div class="card-content">
										<div id="resultData" style="height:210px"></div>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="row mt-4 areaOldBuildingHouseCount" style="display: none;">
			<div class="mb-4">
				<div class="card p-3">
					<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
						<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
							<div class="items" data-sort="4">
								<div class="card-box" data-div-name="areaOldBuildingHouseCount" data-chart="areaOldBuildingHouseCount" >
									<div class="card-title">
										<h3><span class="cht-title"></span> </h3>
									</div>
									<div class="card-content">
										<div id="areaOldBuildingHouseCount" style="height:210px"></div>
									</div>
								</div>
							</div>
						</div>
